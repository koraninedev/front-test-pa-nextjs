...
const skill_1 = require("../typeorm/skill");
const typeorm_2 = require("typeorm");
let SkillService = class SkillService {
    constructor(skillRespository) {
    ...
    async updateEducation(id, updateSkillDTO) {
...
exports.SkillService = SkillService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(skill_1.skill)),
